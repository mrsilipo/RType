...
internal sealed class RaceEngineSampleSound : IDisposable
{
    ...
    public void Update(EngineAudioFrame frame)
    {
        ...
        UpdateSampleLoops(frame, rpm, baseVolume * normalScale, limiterJustReleased);
        ...
        State = default(RaceEngineAudioState) with
        {
            ...
            LimiterCut = frame.HardLimiterActive,
    ...
    private void UpdateSampleLoops(EngineAudioFrame frame, float rpm, float baseVolume, bool snapVolume)
    {
        if (_loops.Length == 0)
        {
            return;
    ...
    private float CalculateBaseVolume(EngineAudioFrame frame, float rpm)
    {
        ...
        float rpmT = SmoothStep(850f, MathF.Max(1200f, frame.LimiterHardCutRpm), rpm);
    ...
    private bool IsLimiterAudioActive => _limiterHardCutActive;
