...
public static class VehicleDefinitionLoader
{
        ...
        string? engineAudioProfileOverridePath)
    {
        ...
        return new VehicleSimulationParameters
        {
            ...
            FrontBumpDampingNsPerM = ReadValueSingle(root, 2900f, "suspension", "front", "bumpDampingNsPerM"),
            RearBumpDampingNsPerM = ReadValueSingle(root, 2500f, "suspension", "rear", "bumpDampingNsPerM"),
            FrontReboundDampingNsPerM = ReadValueSingle(root, 3900f, "suspension", "front", "reboundDampingNsPerM"),
            RearReboundDampingNsPerM = ReadValueSingle(root, 3400f, "suspension", "rear", "reboundDampingNsPerM"),
        ...
        string? engineAudioProfileOverridePath = null)
    {
        ...
        return new VehicleAudioParameters
        {
            ...
            EngineSimulatorProfileTorqueCurveRpm = ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [], "torqueCurveRpm"),
            EngineSimulatorProfileTorqueCurveNm = ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [], "torqueCurveNm"),
            EngineSimulatorProfileEngineBrakeCurveRpm = ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [], "engineBrakeCurveRpm"),
            EngineSimulatorProfileEngineBrakeCurveNm = ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [], "engineBrakeCurveNm"),
