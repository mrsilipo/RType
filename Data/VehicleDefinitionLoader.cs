...
public static class VehicleDefinitionLoader
{
    ...
    private static VehicleAudioParameters ReadAudio(JsonElement root)
    {
        ...
        return new VehicleAudioParameters
        {
            ...
            EngineSimulatorCylinderCount = Math.Max(1, mrProfile?.CylinderCount ?? (int)ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 4f, "cylinderCount")),
            EngineSimulatorFiringOrder = mrProfile?.FiringOrder.Length > 0 ? mrProfile.FiringOrder : ReadEngineSimulatorIntArray(root, engineSimulatorProfile, [1, 3, 4, 2], "firingOrder"),
            EngineSimulatorBoreMillimeters = mrProfile?.BoreMillimeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 81f, "boreMillimeters"),
            EngineSimulatorStrokeMillimeters = mrProfile?.StrokeMillimeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 87.2f, "strokeMillimeters"),
            EngineSimulatorRodLengthMillimeters = mrProfile?.RodLengthMillimeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 137.922f, "rodLengthMillimeters"),
            EngineSimulatorFuelBurningEfficiency = mrProfile?.FuelBurningEfficiency ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 0.75f, "fuelBurningEfficiency"),
            EngineSimulatorFuelTurbulence = mrProfile?.FuelTurbulence ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 2.5f, "fuelTurbulence"),
            EngineSimulatorCylinderAttenuation = mrProfile?.CylinderAttenuation.Length > 0 ? mrProfile.CylinderAttenuation : ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [0.9f, 1.1f, 0.8f, 0.9f], "cylinderAttenuation"),
            EngineSimulatorCylinderExhaust = mrProfile?.CylinderExhaust.Length > 0 ? mrProfile.CylinderExhaust : ReadEngineSimulatorIntArray(root, engineSimulatorProfile, [0, 1, 0, 1], "cylinderExhaust"),
            EngineSimulatorExhaustVolumes = mrProfile?.ExhaustVolumes.Length > 0 ? mrProfile.ExhaustVolumes : ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [6f, 8f], "exhaustVolumes"),
            ...
            EngineSimulatorStarterTorqueNm = mrProfile?.StarterTorqueNm ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 94.91f, "starterTorqueNm"),
            EngineSimulatorStarterSpeedRpm = mrProfile?.StarterSpeedRpm ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, -500f, "starterSpeedRpm"),
            EngineSimulatorCrankshaftFrictionTorqueNm = mrProfile?.CrankshaftFrictionTorqueNm ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 1.36f, "crankshaftFrictionTorqueNm"),
            EngineSimulatorCrankshaftMomentOfInertiaKgM2 = mrProfile?.CrankshaftMomentOfInertiaKgM2 ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 0.114934f, "crankshaftMomentOfInertiaKgM2"),
            EngineSimulatorCrankshaftMassKg = mrProfile?.CrankshaftMassKg ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 16.10f, "crankshaftMassKg"),
            EngineSimulatorFlywheelMassKg = mrProfile?.FlywheelMassKg ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 4.54f, "flywheelMassKg"),
            EngineSimulatorTransmissionMaxClutchTorqueNm = mrProfile?.TransmissionMaxClutchTorqueNm ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 406.75f, "transmissionMaxClutchTorqueNm"),
            EngineSimulatorTransmissionGearRatios = mrProfile?.TransmissionGearRatios.Length > 0 ? mrProfile.TransmissionGearRatios : ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [3.23f, 2.105f, 1.458f, 1.107f, 0.848f], "transmissionGearRatios"),
            EngineSimulatorVehicleMassKg = mrProfile?.VehicleMassKg ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 1088.62f, "vehicleMassKg"),
            EngineSimulatorVehicleDiffRatio = mrProfile?.VehicleDiffRatio ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 3.55f, "vehicleDiffRatio"),
            EngineSimulatorVehicleTireRadiusMeters = mrProfile?.VehicleTireRadiusMeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 0.254f, "vehicleTireRadiusMeters"),
            EngineSimulatorVehicleRollingResistanceN = mrProfile?.VehicleRollingResistanceN ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 300f, "vehicleRollingResistanceN"),
            ...
            EngineSimulatorIgnitionTimingRpm = mrProfile?.IgnitionTimingRpm.Length > 0 ? mrProfile.IgnitionTimingRpm : ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [0f, 1000f, 2000f, 3000f, 4000f], "ignitionTimingRpm"),
            EngineSimulatorIgnitionTimingDegrees = mrProfile?.IgnitionTimingDegrees.Length > 0 ? mrProfile.IgnitionTimingDegrees : ReadEngineSimulatorFloatArray(root, engineSimulatorProfile, [-25f, -25f, -30f, -30f, -30f], "ignitionTimingDegrees"),
            EngineSimulatorIntakePlenumVolumeLiters = mrProfile?.IntakePlenumVolumeLiters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 1.325f, "intakePlenumVolumeLiters"),
            EngineSimulatorIntakeRunnerLengthInches = mrProfile?.IntakeRunnerLengthInches ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 7f, "intakeRunnerLengthInches"),
            EngineSimulatorExhaustPrimaryTubeLengthInches = mrProfile?.ExhaustPrimaryTubeLengthInches ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 10f, "exhaustPrimaryTubeLengthInches"),
            EngineSimulatorExhaustVolumeLiters = mrProfile?.ExhaustVolumeLiters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 100f, "exhaustVolumeLiters"),
            ...
            EngineSimulatorLowIntakeDurationDegrees = mrProfile?.LowIntakeDurationDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 210f, "lowCam", "intakeDurationDegrees"),
            EngineSimulatorLowIntakeLiftMillimeters = mrProfile?.LowIntakeLiftMillimeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 6.9f, "lowCam", "intakeLiftMillimeters"),
            EngineSimulatorLowExhaustDurationDegrees = mrProfile?.LowExhaustDurationDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 190f, "lowCam", "exhaustDurationDegrees"),
            EngineSimulatorLowExhaustLiftMillimeters = mrProfile?.LowExhaustLiftMillimeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 6.5f, "lowCam", "exhaustLiftMillimeters"),
            EngineSimulatorLowCamGamma = mrProfile?.LowCamGamma ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 1f, "lowCam", "gamma"),
            EngineSimulatorLowIntakeCenterDegrees = mrProfile?.LowIntakeCenterDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 116f, "lowCam", "intakeCenterDegrees"),
            EngineSimulatorLowExhaustCenterDegrees = mrProfile?.LowExhaustCenterDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 116f, "lowCam", "exhaustCenterDegrees"),
            EngineSimulatorVtecIntakeDurationDegrees = mrProfile?.VtecIntakeDurationDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 240f, "vtecCam", "intakeDurationDegrees"),
            EngineSimulatorVtecIntakeLiftMillimeters = mrProfile?.VtecIntakeLiftMillimeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 11.5f, "vtecCam", "intakeLiftMillimeters"),
            EngineSimulatorVtecExhaustDurationDegrees = mrProfile?.VtecExhaustDurationDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 232f, "vtecCam", "exhaustDurationDegrees"),
            EngineSimulatorVtecExhaustLiftMillimeters = mrProfile?.VtecExhaustLiftMillimeters ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 10.5f, "vtecCam", "exhaustLiftMillimeters"),
            EngineSimulatorVtecCamGamma = mrProfile?.VtecCamGamma ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 0.5f, "vtecCam", "gamma"),
            EngineSimulatorVtecIntakeCenterDegrees = mrProfile?.VtecIntakeCenterDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 100f, "vtecCam", "intakeCenterDegrees"),
            EngineSimulatorVtecExhaustCenterDegrees = mrProfile?.VtecExhaustCenterDegrees ?? ReadEngineSimulatorValueSingle(root, engineSimulatorProfile, 100f, "vtecCam", "exhaustCenterDegrees"),
